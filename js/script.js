...
function restoreTask(index) {
  ...
  // directly Update the counter of uncompleted tasks 
  if (!restoredTask.completed) {
    const incompleteTasksCount = todo.filter(task => !task.completed).length;
    todoCountP.textContent = `${incompleteTasksCount} Incomplete`;
    todoCountP.style.color = incompleteTasksCount === 0 ? "rgb(0, 233, 0)" : "#97b8ff";
  }
